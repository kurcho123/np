		...
		case 'transactions_page':
			...
			for(var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #602aa7; font-weight: 600;">${db.sender_name}</span>
				...
				// Sent
					...
					icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #602aa7; font-weight: 600;">${db.receiver_name}</span>
				...
				// Deposited
					...
					icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								Into <span style="color: #602aa7; font-weight: 600;">${db.receiver_name}</span>
			...
			$('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #602aa7; border-radius: 10px; color: #fff;">
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #602aa7;">Arthur James</span>
								<div style="margin-top: -5px;">Sent</div>
							</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #602aa7;">Bank Account</span>
								<div style="margin-top: -5px;">Deposited</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
		...
		case 'society_transactions':
			...
			for(var i = 0; i < num; i++) {
				...
				// Withdrawn
					...
					icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #602aa7; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Withdrawn</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()} $</span> </td>`;
				}
...
$(document).on('click', "#overview_page", function() {
	$.post('https://nocore-bank/action', JSON.stringify({
...
function overview_page_function(event) {
	...
	if (event.data.isInAtm){
		buttons = `<div class="card-body" style="background-color: #201d24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
	...
	$('#page_info').html(`
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				...
				<div class="card-body" style="background-color: #201d24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						...
						<div class="card-body" style="background-color: #201d24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #602aa7;">Arthur James</span>
											<div style="margin-top: -5px;">Received</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #602aa7;">Bank Account</span>
											<div style="margin-top: -5px;">Withdrawn</div>
										</td>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #201d24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%; color: #602aa7;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">NoLagBank Classic</span></span><span><i class="fas fa-wifi"></i></span></span>
	...
	for(var i = 0; i < num; i++) {
		...
		// Received
		if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
			icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
		...
		// Sent
			...
			icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
			data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						To <span style="color: #602aa7; font-weight: 600;">${db.receiver_name}</span>
						<div style="margin-top: -5px;">Sent</div>
					</td>`;
	...
	gradient.addColorStop(0, 'rgba(122, 20, 217, 0.5)');
	gradient.addColorStop(1, 'rgba(96, 25, 189, 0)');
...
function society_page_function(event) {
	...
	for(var i = 0; i < num; i++) {
		...
		// Deposited
			...
			icon = '<td class="align-middle"><span style="background-color: #201d24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
			data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						Into <span style="color: #602aa7; font-weight: 600;">${db.sender_name}</span>
						<div style="margin-top: -5px;">Deposited</div>
					</td>`;
			amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ ${db.value.toLocaleString()} $</span> </td>`;
		// Withdrawn
	...
	$('#page_info').html(`
		<div class="col-md-12 d-flex flex-grow-1 flex-column h-100" style="flex: 1 1 50%;">
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				...
				<div class="card-body flex-grow-1" style="background-color: #201d24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #602aa7; border-radius: 10px; color: #fff;">
