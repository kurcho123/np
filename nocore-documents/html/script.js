...
function Form (_title, _subtitle, _elements, _submittable)
{
	...
	this.submit = function() { 
		...
		if (can_submit) {
			$.post('http://nocore-documents/form_submit', json_string);
			activeform.close();
		}
	...
	this.print = function () { 
		...
		html_footer += "</div>";
		html_footer += "<div id=\"signature_block\">Подпиши се.</div>";
	...
	this.close = function() {
		...
		$.post('http://nocore-documents/form_close', JSON.stringify({}));
	}
}
