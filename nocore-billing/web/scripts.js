				...
				if (event.data.society == true){
					row = `	<div class="col col-md-4">
								<div class="card h-100">
								  <div class="card-body text-center mainmenu-subcard" id="menuMyInvoices" style="background-color: #292a31; color: #c8c9cf;">
							...
							<div class="col col-md-4">
								<div class="card h-100">
								  <div class="card-body text-center mainmenu-subcard" id="menuSocietyInvoices" style="background-color: #292a31; color: #c8c9cf;">
							...
							<div class="col col-md-4">
								<div class="card h-100">
								  <div class="card-body text-center mainmenu-subcard" id="menuCreateInvoice" style="background-color: #292a31; color: #c8c9cf;">
			...
			if (!windowIsOpened) {
				...
				for(var i=0; i<event.data.invoices.length; i++)
				{
					...
					if (invoices.status == 'paid') {
						...
						payment_status = `<span style="font-size: 20px; color: #c8c9cf; text-transform: uppercase; font-weight: 600;">PAID ON: ${invoices.paid_date}</span>`;
					}
						...
						payment_status = `<span style="font-size: 20px; color: #c8c9cf; text-transform: uppercase; font-weight: 600;">AUTOPAID ON: ${invoices.paid_date}</span>`;
					}
						...
						payment_status = '<span style="font-size: 20px; color: #c8c9cf; text-transform: uppercase; font-weight: 600;">CANCELLED</span>'
					}
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content myinvoices_modal-content">
											<div class="modal-body p-4">
												...
												${limit_pay_date}
												<h6 class="" id="" style="margin-top: 20px;">To: <span style="color: #c8c9cf;">${invoices.receiver_name}</span></h6>
												<h6 class="" id="" style="">From: <span style="color: #c8c9cf;">${invoices.author_name}</span></h6>
												<hr>
												<div class="d-flex justify-content-between">
													<span class="" id="" style="color: #c8c9cf; font-size: 20px;">${invoices.item}</span> <span class="" id="" style="font-size: 18px;">${Math.round(invoices.invoice_value - Math.round(invoices.invoice_value * (event.data.VAT/100))).toLocaleString()} &euro;</span>
												</div>
												<hr>
												<div class="d-flex justify-content-between">
													<span class="" id="" style="color: #c8c9cf; font-size: 20px;">Subtotal</span> <span class="" id="" style="font-size: 18px;">${Math.round(invoices.invoice_value - Math.round(invoices.invoice_value * (event.data.VAT/100))).toLocaleString()} &euro;</span>
												</div>
												<div class="d-flex justify-content-between">
													<span class="" id="" style="color: #c8c9cf; font-size: 20px;">VAT (${event.data.VAT}%)</span> <span class="" id="" style="font-size: 18px;">${Math.round(invoices.invoice_value * (event.data.VAT/100)).toLocaleString()} &euro;</span>
												</div>
												<br>
												<div class="d-flex justify-content-between">
													<span class="" id="" style="color: #c8c9cf; font-size: 20px; font-weight: 700;">Total</span> <span class="" id="" style="font-size: 18px;">${Math.round(invoices.invoice_value).toLocaleString()} &euro;</span>
												</div>
												<br>
...
$(document).on('click', ".payInvoice", function() {
	...
	$.post('https://nocore-billing/action', JSON.stringify ({
		action: "payInvoice",
...
$(document).on('click', '#menuMyInvoices', function() {
	...
	$.post('http://nocore-billing/action', JSON.stringify ({
