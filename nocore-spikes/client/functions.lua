...
RegisterNetEvent("nocore-spikes:placeSpikestrip")
AddEventHandler("nocore-spikes:placeSpikestrip", function()
    DeployStinger()
end)
...
function RemoveStinger()
    if DoesEntityExist(closestStinger) then
        ...
        if not DoesEntityExist(closestStinger) then
            TriggerServerEvent("nocore-spikes:removedSpike")
        end
    end
end

RegisterNetEvent("nocore-spikes:removeSpikestrip")
AddEventHandler("nocore-spikes:removeSpikestrip", function()
    RemoveStinger()
end)
