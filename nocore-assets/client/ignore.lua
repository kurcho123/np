...
CreateThread(function() -- all these should only need to be called once
	local pos = vector3(331.24, -1430.25, 46.50)
	local radius = 50
	SetAllVehicleGeneratorsActiveInArea(pos - radius, pos + radius, false, false)
	...
	RemoveVehiclesFromGeneratorsInArea(807.61 - 300.0, -811.52 - 300.0, 26.54 - 300.0, 807.61 + 300.0, -811.52 + 300.0, 26.54 + 300.0) -- Fraud auto
end)
