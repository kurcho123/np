const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: 'https://imgur.com/XydHnQm.png', // Instead of icon it's using a image source found in HTML 
            CurrentIcon: 'https://imgur.com/XydHnQm.png', // Instead of icon it's using a image source found in HTML
            SuccessIcon: 'https://imgur.com/kFyFLdr.png', // Instead of icon it's using a image source found in HTML
            SuccessColor: "rgb(122, 68, 255)",
            StandardColor: "white",
            TargetHTML: "",
