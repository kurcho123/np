Gardener = {}
Gardener.CompanyVehicle = "burrito3"
Gardener.DepositPrice = 150
Gardener.Config = {
    Base = {
    ...
    Garage = {
		...
		Type  = 27,
        BlipSprite = 524,
        BlipLabel = '[Gardener] Гараж',
        BlipColor = 43,
        BlipScale = 0.5,
	},
    GarageSpawnPoint = {
		Pos1   = {x = -1742.93, y = -724.02, z = 10.44, a = 229.58},
        Pos2   = {x = -1741.03, y = -721.79, z = 10.47, a = 229.58},
	},
    DefaultMarker = {
		Size  = {x = 1.2, y = 1.2, z = 1.0},
        Color = {r = 78, g = 2453, b = 175},
