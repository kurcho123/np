...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 10, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://cdn.discordapp.com/attachments/902663901848686693/931949415776788500/20220115_183407_0000.png",
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Emotes',
        ['danceemotes'] = "Dance",
        ['hidanemotes'] = "Hi Dance",
        ['midanemotes'] = "Mi Dance",
        ['lidanemotes'] = "Li Dance",
        ['crazydanemotes'] = "Crazy Dance",
        ['propdanemotes'] = "Prop Dance",
        ['sidedanemotes'] = "Side Dance",
        ['hidanfemotes'] = "Hi Dance Female",
        ['midanfemotes'] = "Mi Dance Female",
        ['lidanfemotes'] = "Li Dance Female",
        ['propemotes'] = "Prop",
        ['smokeemotes'] = "Smoke",
        ['idleemotes'] = "Pose",
        ['jobsemotes'] = "Jobs",
        ['otheremotes'] = "Other",
        ['reactionemotes'] = "Reaction",
        ['sitemotes'] = "Sit and lying",
        ['phoneemotes'] = "Phone",
        ['drinkemotes'] = "Drink",
        ['clubemotes'] = "Sport",
