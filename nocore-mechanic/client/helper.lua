...
function SetVehicleModData(vehicle, modType, data)
	...
	elseif (modType == 'color1') then
		...
		Framework.Functions.TriggerCallback('nocore-vehicleshop:SaveVehicleProps', function(result)
		end, Framework.Functions.GetVehicleProperties(vehicle))
	...
	elseif (modType == 'interiorcolor') then
		SetVehicleInteriorColor(vehicle, data)
		Framework.Functions.TriggerCallback('nocore-vehicleshop:SaveVehicleProps', function(result)
		end, Framework.Functions.GetVehicleProperties(vehicle))
	elseif (modType == 'dashboardcolor') then
		SetVehicleDashboardColor(vehicle, data)
		Framework.Functions.TriggerCallback('nocore-vehicleshop:SaveVehicleProps', function(result)
		end, Framework.Functions.GetVehicleProperties(vehicle))
...
function repairtVehicle(vehicle, gobackmenu)
