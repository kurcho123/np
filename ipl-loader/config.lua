...
config.mazeBankPowerBrokerIce                = true -- -75.56978, -827.1152, 243.3859
config.mazeBankPowerBrokerConservative       = false -- -75.51953, -827.0786, 243.3859
config.mazeBankPowerBrokerPolished           = false  -- -75.41915, -827.1118, 243.3858
...
config.graffiti                              = false  -- 1861.28, 2402.11, 58.53/2697.32, 3162.18, 58.1/2119.12, 3058.21, 53.25
config.ussLuxington                          = false  -- 3082.312 -4717.119 15.262
-- Yachts
...
config.morgue                                = false  -- 239.752, -1360.650, 39.534
...
config.banhamCanyonHouse                     = false  -- -3086.428, 339.252, 6.372
...
config.bunkerUpgradeSet                      = false
config.bunkerStandardSecuritySet             = false
config.bunkerUpgradeSecuritySet              = false
config.bunkerOfficeBlockerSet                = false
config.bunkerOfficeUpgradeSet                = false
config.bunkerGunRangeBlockerSet              = false
config.bunkerWallBlocker                     = false
config.bunkerGunRangeLights                  = false
config.bunkerGunLockerUpgrade                = false
config.bunkerGunSchematicSet                 = false

-- FIB Lobby - 110.4, -744.2, 45.7496

config.fibProps                              = false
